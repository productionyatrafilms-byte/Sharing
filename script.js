    document.addEventListener("DOMContentLoaded", () => {
      ...
      const titleSpan = document.querySelector(".home-title span") || document.querySelector(".sharing-title span");
      const titleP = document.querySelector(".home-title p") || document.querySelector(".sharing-title p");
      ...
      const subtitle = {
        ...
        hi: "बाँटना ही परवाह करना है",
        gu: "વહેંચવું એ જ સંભાળ છે",
      };
      ...
      function setLang(lang) {
        ...
        if (lang === "en" && englishButton) englishButton.classList.add("lang-active");
        if (lang === "hi" && hindiButton) hindiButton.classList.add("lang-active");
        if (lang === "gu" && gujaratiButton) gujaratiButton.classList.add("lang-active");
      }

      // attach click events only if buttons exist on page
      if (englishButton) englishButton.addEventListener("click", () => setLang("en"));
      if (hindiButton) hindiButton.addEventListener("click", () => setLang("hi"));
      if (gujaratiButton) gujaratiButton.addEventListener("click", () => setLang("gu"));
      ...
      if (typeof Swiper !== "undefined" && document.querySelector('.mySwiper')) {
        ...
        function updateNavVisibility() {
          if (prevBtn) prevBtn.style.visibility = swiper.isBeginning ? 'hidden' : 'visible';
        }
        ...
        function playActiveVideo() {
          ...
          const activeVideo = document.querySelector('.mySwiper .swiper-slide-active .slide-media');
